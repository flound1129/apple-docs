...
Use the [hoverEffectGroup(_:)](/documentation/swiftui/customhovereffect/hovereffectgroup(_:)-swift.type.method) or [hoverEffectGroup(id:in:behavior:)](/documentation/swiftui/customhovereffect/hovereffectgroup(id:in:behavior:)-swift.type.method) methods to construct a [GroupHoverEffect](/documentation/swiftui/grouphovereffect).
