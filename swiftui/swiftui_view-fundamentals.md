...
Compose a custom view by combining built-in views that SwiftUI provides with other custom views that you create in your view’s [body](/documentation/swiftui/view/body-8kl5o) computed property. Configure views using the view modifiers that SwiftUI provides, or by defining your own view modifiers using the [ViewModifier](/documentation/swiftui/viewmodifier) protocol and the [modifier(_:)](/documentation/swiftui/view/modifier(_:)) method.
