...
- [blendMode(_:)](/documentation/swiftui/shapestyle/blendmode(_:)-swift.method): Returns a new style based on `self` that applies the specified blend mode when drawing.
- [opacity(_:)](/documentation/swiftui/shapestyle/opacity(_:)-swift.method): Returns a new style based on `self` that multiplies by the specified opacity when drawing.
...
- [blendMode(_:)](/documentation/swiftui/shapestyle/blendmode(_:)-swift.type.method): Returns a new style based on the current style that uses `mode` as its blend mode when drawing.
- [opacity(_:)](/documentation/swiftui/shapestyle/opacity(_:)-swift.type.method): Returns a new style based on the current style that multiplies by `opacity` when drawing.
...
- [resolve(in:)](/documentation/swiftui/shapestyle/resolve(in:)): Evaluate to a resolved shape style given the current `environment`.
