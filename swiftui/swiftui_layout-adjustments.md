...
To get started with a basic layout, see [Layout fundamentals](/documentation/swiftui/layout-fundamentals). For design guidance, see [Layout](/design/Human-Interface-Guidelines/layout) in the Human Interface Guidelines.
