...
- [TabViewCustomization.SectionCustomization](/documentation/swiftui/tabviewcustomization/sectioncustomization): The customizations a user has made to a [TabSection](/documentation/swiftui/tabsection).
- [TabViewCustomization.TabCustomization](/documentation/swiftui/tabviewcustomization/tabcustomization): The customizations a user has made to a [Tab](/documentation/swiftui/tab).
...
- [resetSectionOrder(for:)](/documentation/swiftui/tabviewcustomization/resetsectionorder(for:)): Resets ordering back to the default for the section with `sectionID`, preserving any customized tab visibilities.
