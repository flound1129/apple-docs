...
For example, people can move forward and backward through a stack of views using a [NavigationStack](/documentation/swiftui/navigationstack), or choose which view to display from a tab bar using a [TabView](/documentation/swiftui/tabview).
...
- [Understanding the navigation stack](/documentation/swiftui/understanding-the-navigation-stack): Learn about the navigation stack, links, and how to manage navigation types in your app’s structure.
