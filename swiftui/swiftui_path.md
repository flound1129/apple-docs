...
- [description](/documentation/swiftui/path/description): A description of the path that may be used to recreate the path via `init?(_:)`.
...
- [forEach(_:)](/documentation/swiftui/path/foreach(_:)): Calls `body` with each element in the path.
- [Path.Element](/documentation/swiftui/path/element): An element of a path.

### Applying a style

- [strokedPath(_:)](/documentation/swiftui/path/strokedpath(_:)): Returns a stroked copy of the path using `style` to define how the stroked outline is created.
