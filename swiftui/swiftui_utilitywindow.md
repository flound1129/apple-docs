...
`UtilityWindow` will automatically add a menu item to show/hide itself in the “View” menu. This can be removed by applying [commandsRemoved()](/documentation/swiftui/scene/commandsremoved()) to the utility window, and manually placing a [WindowVisibilityToggle](/documentation/swiftui/windowvisibilitytoggle) elsewhere in an app’s commands. Utility windows can also be programmatically presented with [openWindow](/documentation/swiftui/environmentvalues/openwindow) and dismissed using [dismiss](/documentation/swiftui/environmentvalues/dismiss).
