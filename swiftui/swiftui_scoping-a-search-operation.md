...
You can change when the picker appears by using the [searchScopes(_:activation:_:)](/documentation/swiftui/view/searchscopes(_:activation:_:)) modifier instead, and supplying one of the [SearchScopeActivation](/documentation/swiftui/searchscopeactivation) values, like [onTextEntry](/documentation/swiftui/searchscopeactivation/ontextentry) or [onSearchPresentation](/documentation/swiftui/searchscopeactivation/onsearchpresentation).
