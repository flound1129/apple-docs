...
- [custom(_:fixedSize:)](/documentation/swiftui/font/custom(_:fixedsize:)): Create a custom font with the given `name` and a fixed `size` that does not scale with Dynamic Type.
- [custom(_:size:relativeTo:)](/documentation/swiftui/font/custom(_:size:relativeto:)): Create a custom font with the given `name` and `size` that scales relative to the given `textStyle`.
- [custom(_:size:)](/documentation/swiftui/font/custom(_:size:)): Create a custom font with the given `name` and `size` that scales with the body text style.
