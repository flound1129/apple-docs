...
- [immersiveSpace](/documentation/swiftui/coordinatespaceprotocol/immersivespace): The named coordinate space that represents the currently opened [ImmersiveSpace](/documentation/swiftui/immersivespace) scene. If no immersive space is currently opened, this CoordinateSpace provides the same behavior as the `.global` coordinate space.
