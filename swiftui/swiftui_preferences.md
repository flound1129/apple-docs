...
When you use the [PreferenceKey](/documentation/swiftui/preferencekey) protocol to define a custom preference, you indicate how to merge preferences from multiple subviews. You can then set a value for the preference on a view using the [preference(key:value:)](/documentation/swiftui/view/preference(key:value:)) view modifier. Many built-in modifiers, like [navigationTitle(_:)](/documentation/swiftui/view/navigationtitle(_:)), rely on preferences to send configuration information to their container.
