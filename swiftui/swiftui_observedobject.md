...
Add the `@ObservedObject` attribute to a parameter of a SwiftUI [View](/documentation/swiftui/view) when the input is an [ObservableObject](/documentation/Combine/ObservableObject) and you want the view to update when the object’s published properties change. You typically do this to pass a [StateObject](/documentation/swiftui/stateobject) into a subview.
