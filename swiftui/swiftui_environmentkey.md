...
You can create custom environment values by extending the [EnvironmentValues](/documentation/swiftui/environmentvalues) structure with new properties. First declare a new environment key type and specify a value for the required [defaultValue](/documentation/swiftui/environmentkey/defaultvalue) property:
