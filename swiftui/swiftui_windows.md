...
The most common way to present a view hierarchy in your app’s interface is with a [WindowGroup](/documentation/swiftui/windowgroup), which produces a platform-specific behavior and appearance.
