...
- [init(editing:migrationPlan:editor:prepareDocument:)](/documentation/swiftui/documentgroup/init(editing:migrationplan:editor:preparedocument:)): Instantiates a document group for creating and editing documents described by the last `Schema` in the migration plan.
...
- [init(viewing:migrationPlan:viewer:)](/documentation/swiftui/documentgroup/init(viewing:migrationplan:viewer:)): Instantiates a document group for viewing documents described by the last `Schema` in the migration plan.
