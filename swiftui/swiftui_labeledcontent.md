...
You can use labeled content as the label for other elements. For example, a [NavigationLink](/documentation/swiftui/navigationlink) can present a summary value for the destination it links to:
...
You can set label styles using the [labeledContentStyle(_:)](/documentation/swiftui/view/labeledcontentstyle(_:)) modifier. You can also build custom styles using [LabeledContentStyle](/documentation/swiftui/labeledcontentstyle).
