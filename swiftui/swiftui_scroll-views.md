...
When the content of a view doesn’t fit in the display, you can wrap the view in a [ScrollView](/documentation/swiftui/scrollview) to enable people to scroll on one or more axes. Configure the scroll view using view modifiers. For example, you can set the visibility of the scroll indicators or the availability of scrolling in a given dimension.
...
For design guidance, see [Scroll views](/design/Human-Interface-Guidelines/scroll-views) in the Human Interface Guidelines.
