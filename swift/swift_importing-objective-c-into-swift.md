...
![Diagram showing the steps to import Objective-C declarations into Swift code. Import your Objective-C headers into an Objective-C bridging header file to expose the declarations to all your Swift files.]
...
![Screenshot of the Xcode prompt to configure an Objective-C bridging header.]
