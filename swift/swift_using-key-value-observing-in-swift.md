...
You use the `oldValue` and `newValue` properties of the [NSKeyValueObservedChange](/documentation/Foundation/NSKeyValueObservedChange) instance to see what’s changed about the property you’re observing.
