...
![A screenshot of Xcode showing the Swift Compiler - Upcoming Features build settings]
...
![A screenshot of Xcode showing the Swift Compiler - Language build settings]
