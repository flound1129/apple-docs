...
In Swift, you can call C variadic functions, such as `vasprintf(_:_:_:)`, using the Swift [getVaList(_:)](/documentation/swift/getvalist(_:)) or [withVaList(_:_:)](/documentation/swift/withvalist(_:_:)) functions. The `withVaList(_:_:)` function takes an array of [CVarArg](/documentation/swift/cvararg) values and provides a [CVaListPointer](/documentation/swift/cvalistpointer) value within the body of a closure parameter, whereas the `getVaList(_:)` function returns this value directly. With either function, you pass the resulting `CVaListPointer` value as the `va_list` argument of the C variadic function.
...
| --- | --- |
| `const Type *` | [UnsafePointer](/documentation/swift/unsafepointer)<Type> |
| `Type *` | [UnsafeMutablePointer](/documentation/swift/unsafemutablepointer)<Type> |

For class types, the following mappings apply:

| C Syntax | Swift Syntax |
| --- | --- |
| `Type * const *` | [UnsafePointer](/documentation/swift/unsafepointer)<Type> |
| `Type * __strong *` | [UnsafeMutablePointer](/documentation/swift/unsafemutablepointer)<Type> |
| `Type **` | [AutoreleasingUnsafeMutablePointer](/documentation/swift/autoreleasingunsafemutablepointer)<Type> |

For pointers to untyped, raw memory, the following mappings apply:

| C Syntax | Swift Syntax |
| --- | --- |
| `const void *` | [UnsafeRawPointer](/documentation/swift/unsaferawpointer) |
| `void *` | [UnsafeMutableRawPointer](/documentation/swift/unsafemutablerawpointer) |
