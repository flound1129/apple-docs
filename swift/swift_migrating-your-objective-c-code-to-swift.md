...
2. As you work with Objective-C APIs, you’ll need to know how Swift translates certain Objective-C language features. For more information, see [Objective-C and C Code Customization](/documentation/swift/objective-c-and-c-code-customization).
